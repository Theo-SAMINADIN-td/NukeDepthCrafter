...
if __name__ == "__main__":
    ...
    parser.add_argument("--track_time", type=bool, default=True, help="Track time")
...
video_paths = ["D:\AI\DepthCrafterPlugin\examples\\testvid.mp4"]#args.video_path.split(",")
for video in video_paths:
    depthcrafter_demo.infer(
        video,
        25,                    # args.num_inference_steps,
        1.2,                    # args.guidance_scale,
        save_folder="./demo_output",       #args.save_folder,
        window_size= 110,       #args.window_size,
        process_length= 195 ,       #args.process_length,
        overlap= 25,              #args.overlap,
        max_res= 1024 ,              #args.max_res,
        target_fps= 15 ,           #args.target_fps,
        seed= 42  ,                 #args.seed,
